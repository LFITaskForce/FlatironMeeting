...
| pydelfi tutorial |   @justinalsing        | @changhoonhahn | @changhoonhahn, @johannbrehmer , @viajani, @VMBoehm | | 
| summary of available software packages |           | @dfm | @dfm, @johannbrehmer, @dch216, @changhoonhahn @cranmer  | | 
| Intro to TensorFlow Probability by building a conditional density estimator for discrete counts | @EiffL | @EiffL | @changhoonhahn, @pelssers, @VMBoehm |  |
| Nuisance hardened data compression/LFI of nuisance marginalized posteriors | @justinalsing | @justinalsing | @changhoonhahn, @VMBoehm |  |
